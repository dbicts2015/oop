...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Een cylinder met straal %.2f en hoogte %.2f heeft oppervlakte %.2f en volume %.2f\n",
						cylinder.getRadius(), cylinder.getHeight(), cylinder.area(), cylinder.volume());
